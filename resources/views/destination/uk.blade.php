<x-layouts.subpage>
    ...
    <main>
        <div class="shell -mt-8 relative z-10">
            <img src="{{ asset('/images/destination/uk.png') }}" alt="Wireframing Hero" class="w-full h-[400px] md:h-[600px] object-cover rounded-2xl shadow-card">
        </div>
            ...
            <div class="max-w-3xl mx-auto">
                <div class="border-b border-b-slate-200 py-4 my-2">
                    <p class="pb-[30px] mb-[16px]">
                        The United Kingdom is one of the world’s most prestigious education destinations. 
                        With renowned universities, shorter course durations, and the UK Graduate Route 
                        visa allowing up to 2 years of post-study work, the UK offers exceptional 
                        value and strong career outcomes for international students.
                    </p>
                ...
                <h2 class="font-inter font-semibold text-[24px] leading-[32px] mb-[24px] text-[#181D27] tracking-[0%]">List of Schools in the United Kingdom</h2>
