<x-layouts.subpage>
    ...
    <main>
        <div class="shell -mt-8 relative z-10">
            <img src="{{ asset('/images/destination/new-zeeland.jpg') }}" alt="Wireframing Hero" class="w-full h-[400px] md:h-[600px] object-cover rounded-2xl shadow-card">
        </div>
            ...
            <div class="max-w-3xl mx-auto">
                <div class="border-b border-b-slate-200 py-4 my-2">
                    <p class="pb-[30px] mb-[16px]">
                        New Zealand delivers world-class education in a safe, clean, 
                        and naturally beautiful environment with recognised qualifications 
                        and good post-study work opportunities.
                    </p>
                ...
                <h2 class="font-inter font-semibold text-[24px] leading-[32px] mb-[24px] text-[#181D27] tracking-[0%]">List of Schools in New Zealand</h2>
                <article>
                    <ul class="list-disc list-outside ml-6 space-y-2">
                        <li class="font-inter font-normal text-[#535862] text-[16px] lg:text-[18px] leading-[24px] lg:leading-[28px] mb-[16px] lg:mb-[18px]">University of Canterbury College (Navitas)</li>
